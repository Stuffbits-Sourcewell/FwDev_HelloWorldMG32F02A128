...
#define _MG32x02z__RegPointer_H_VER                 1.12    /*!< File Version */

#if !(MG32x02z_H_VER == MG32x02z__RegPointer_H_VER)
    #error "MG32x02z__RegPointer_H - Main/Module Version Mismatch !"
#endif
...
#define CFG_TST1_PLL_TST                            CFG->TST1.MBIT.PLL_TST          //[24] PLL test enable. pll_tstcko output on PC14.
...
#define APX_STA_SDTF3                               APX->STA.MBIT.SDTF3             //[11] SDT state procedures-3 detect flag
#define APX_STA_SDTF2                               APX->STA.MBIT.SDTF2             //[10] SDT state procedures-2 detect flag
#define APX_STA_SDTF1                               APX->STA.MBIT.SDTF1             //[9] SDT state procedures-1 detect flag
#define APX_STA_SDTF0                               APX->STA.MBIT.SDTF0             //[8] SDT idle state detection flag.  (set by hardware and clear by software writing 1)
///@}
/**
 ******************************************************************************
...
#define APX_INT_SDT_IE5                             APX->INT.MBIT.SDT_IE5           //[13] SDT state procedure-5 detect interrupt enable. (User definition mode precedure)
#define APX_INT_SDT_IE4                             APX->INT.MBIT.SDT_IE4           //[12] SDT state procedure-4 detect interrupt enable. (User definition mode precedure)
#define APX_INT_SDT_IE3                             APX->INT.MBIT.SDT_IE3           //[11] SDT state procedure-3 detect interrupt enable. (Escape mode request precedure)
#define APX_INT_SDT_IE2                             APX->INT.MBIT.SDT_IE2           //[10] SDT state procedure-2 detect interrupt enable
#define APX_INT_SDT_IE1                             APX->INT.MBIT.SDT_IE1           //[9] SDT state procedure-1 detect interrupt enable. (High speed mode request precedure)
#define APX_INT_SDT_IE0                             APX->INT.MBIT.SDT_IE0           //[8] SDT idle state detection interrupt enable.
...
#define APX_CCL00_CCL0_TRUTH                        APX->CCL00.MBIT.CCL0_TRUTH      //[23..16] CCL lookup truth table output value difinitions for mapping input states.
...
#define APX_CCL10_CCL1_LUT                          APX->CCL10.MBIT.CCL1_LUT        //[23..16] CCL lookup truth table output value difinitions for mapping input states.
...
#define APX_SDT0_SDT_E1SEL                          APX->SDT0.MBIT.SDT_E1SEL        //[24] SDT internal event-1 output source select.
#define APX_SDT0_SDT_E0NS                           APX->SDT0.MBIT.SDT_E0NS         //[22..20] SDT internal event-0 output inactive trigger source select.
#define APX_SDT0_SDT_E0AS                           APX->SDT0.MBIT.SDT_E0AS         //[18..16] SDT internal event-0 output active trigger source select.
