...
#define _MG32x02z_CFG_H_VER                         1.12    /*!< File Version */

#if !(MG32x02z_H_VER == MG32x02z_CFG_H_VER)
    #error "MG32x02z_CFG_H - Main/Module Version Mismatch !"
#endif
...
typedef struct
{
    ...
    union
    {
        ...
        struct
        {
            ...
            __I  uint8_t                :1;     //[3] 
            __I  uint8_t                :1;     //[4] 
            __I  uint8_t  LVRDE         :1;     //[5] OR control bit. (This bit is loaded by inverting from option byte flash data.)
                                        //0= Disable
                                        //1= Enable
    ...
    union
    {
        ...
        struct
        {
            ...
            __IO uint8_t  ILRCO_EN      :1;     //[18] Internal Low frequency RC Oscillator Enable
                                        ...
                                        //1 = Enable
            __I  uint8_t                :5;     //[23..19] 
            __IO uint8_t  PLL_TST       :1;     //[24] PLL test enable. pll_tstcko output on PC14.
                                        //0 = Disable
                                        //1 = Enable
