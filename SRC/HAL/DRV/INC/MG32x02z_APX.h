...
#define _MG32x02z_APX_H_VER                         1.12    /*!< File Version */

#if !(MG32x02z_H_VER == MG32x02z_APX_H_VER)
    #error "MG32x02z_APX_H - Main/Module Version Mismatch !"
#endif
...
typedef struct
{
    union
    {
        ...
        struct
        {
            __I  uint8_t                :1;     //[0] 
            __I  uint8_t                :7;     //[7..1] 
            __IO uint8_t  SDTF0         :1;     //[8] SDT idle state detection flag.  (set by hardware and clear by software writing 1)
                                        //0 = Normal (No event occurred)
                                        //1 = Happened (reset event happened)
            __IO uint8_t  SDTF1         :1;     //[9] SDT state procedures-1 detect flag
                                        //0 = Normal (No event occurred)
                                        //1 = Happened (reset event happened)
            __IO uint8_t  SDTF2         :1;     //[10] SDT state procedures-2 detect flag
                                        //0 = Normal (No event occurred)
                                        //1 = Happened (reset event happened)
            __IO uint8_t  SDTF3         :1;     //[11] SDT state procedures-3 detect flag
                                        //0 = Normal (No event occurred)
                                        //1 = Happened (reset event happened)
    ...
    union
    {
        ...
        struct
        {
            ...
            __I  uint8_t                :3;     //[3..1] 
            __I  uint8_t                :4;     //[7..4] 
            __IO uint8_t  SDT_IE0       :1;     //[8] SDT idle state detection interrupt enable.
                                        //0 = Disable
                                        //1 = Enable
            __IO uint8_t  SDT_IE1       :1;     //[9] SDT state procedure-1 detect interrupt enable. (High speed mode request precedure)
                                        //0 = Disable
                                        //1 = Enable
            __IO uint8_t  SDT_IE2       :1;     //[10] SDT state procedure-2 detect interrupt enable
                                        //0 = Disable
                                        //1 = Enable
            __IO uint8_t  SDT_IE3       :1;     //[11] SDT state procedure-3 detect interrupt enable. (Escape mode request precedure)
                                        //0 = Disable
                                        //1 = Enable
            __IO uint8_t  SDT_IE4       :1;     //[12] SDT state procedure-4 detect interrupt enable. (User definition mode precedure)
                                        //0 = Disable
                                        //1 = Enable
            __IO uint8_t  SDT_IE5       :1;     //[13] SDT state procedure-5 detect interrupt enable. (User definition mode precedure)
                                        //0 = Disable
                                        //1 = Enable
            __I  uint8_t                :2;     //[15..14] 
    ...
    union
    {
        ...
        struct
        {
            ...
            __I  uint8_t                :2;     //[15..14] 
            __IO uint8_t  CCL0_TRUTH    :8;     //[23..16] CCL lookup truth table output value difinitions for mapping input states.
    ...
    union
    {
        ...
        struct
        {
            ...
            __IO uint8_t  CCL1_DIV      :2;     //[13..12] CCL internal clock input divider.
                                        ...
                                        //0x3 = DIV8 : divided by 8
            __I  uint8_t                :2;     //[15..14] 
            __IO uint8_t  CCL1_LUT      :8;     //[23..16] CCL lookup truth table output value difinitions for mapping input states.
    ...
    union
    {
        ...
        struct
        {
            ...
            __IO uint8_t  SDT_PSEL      :4;     //[11..8] SDT output pin SDT_P0 source select
                                        //0x0 = PROC0 : state procedure-0 detect event
                                        //0x1 = PROC1 : state procedure-1 detect event
                                        //0x2 = PROC2 : state procedure-2 detect event
                                        //0x3 = PROC3 : state procedure-3 detect event
                                        //0x4 = PROC4 : state procedure-4 detect event
                                        //0x5 = PROC5 : state procedure-5 detect event
                                        //0x6 = Reserved
                                        //0x7 = Reserved
                                        //0x8 = E0 : SDT internal event-0
                                        //0x9 = E1 : SDT internal event-1
                                        //0xA = E2 : SDT internal event-2
            __I  uint8_t                :4;     //[15..12] 
            __IO uint8_t  SDT_E0AS      :3;     //[18..16] SDT internal event-0 output active trigger source select.
                                        //0x0 = DIsable
                                        //0x1 = PROC1 : state procedure-1 detect event
                                        //0x2 = PROC2 : state procedure-2 detect event
                                        //0x3 = PROC3 : state procedure-3 detect event
                                        ...
                                        //0x5 = PROC5 : state procedure-5 detect event
            __I  uint8_t                :1;     //[19] 
            __IO uint8_t  SDT_E0NS      :3;     //[22..20] SDT internal event-0 output inactive trigger source select.
                                        //0x0 = PROC0 : idle state detect event
                                        //0x1 = PROC1 : state procedure-1 detect event
                                        //0x2 = PROC2 : state procedure-2 detect event
                                        //0x3 = PROC3 : state procedure-3 detect event
                                        //0x4 = PROC4 : state procedure-4 detect event
                                        //0x5 = PROC5 : state procedure-5 detect event
            __I  uint8_t                :1;     //[23] 
            __IO uint8_t  SDT_E1SEL     :1;     //[24] SDT internal event-1 output source select.
                                        //0 = SDT_I0 : SDT_I0 input signal
                                        //1 = SDT_I1 : SDT_I1 input signal
            __I  uint8_t                :5;     //[29..25] 
...
#define APX_STA_SDTF3_mask_w                        ((uint32_t)0x00000800)  /*!< Bit Mask of 32bit */
#define APX_STA_SDTF3_mask_h0                       ((uint16_t)0x0800)      /*!< Bit Mask of 16bit */
#define APX_STA_SDTF3_mask_b1                       ((uint8_t )0x08)        /*!< Bit Mask of 8bit */
#define APX_STA_SDTF3_normal_w                      ((uint32_t)0x00000000)  /*!< Bit Value =(0):Normal of 32bit */
#define APX_STA_SDTF3_normal_h0                     ((uint16_t)0x0000)      /*!< Bit Value =(0):Normal of 16bit */
#define APX_STA_SDTF3_normal_b1                     ((uint8_t )0x00)        /*!< Bit Value =(0):Normal of 8bit */
#define APX_STA_SDTF3_happened_w                    ((uint32_t)0x00000800)  /*!< Bit Value =(1):Happened of 32bit */
#define APX_STA_SDTF3_happened_h0                   ((uint16_t)0x0800)      /*!< Bit Value =(1):Happened of 16bit */
#define APX_STA_SDTF3_happened_b1                   ((uint8_t )0x08)        /*!< Bit Value =(1):Happened of 8bit */

#define APX_STA_SDTF2_mask_w                        ((uint32_t)0x00000400)  /*!< Bit Mask of 32bit */
#define APX_STA_SDTF2_mask_h0                       ((uint16_t)0x0400)      /*!< Bit Mask of 16bit */
#define APX_STA_SDTF2_mask_b1                       ((uint8_t )0x04)        /*!< Bit Mask of 8bit */
#define APX_STA_SDTF2_normal_w                      ((uint32_t)0x00000000)  /*!< Bit Value =(0):Normal of 32bit */
#define APX_STA_SDTF2_normal_h0                     ((uint16_t)0x0000)      /*!< Bit Value =(0):Normal of 16bit */
#define APX_STA_SDTF2_normal_b1                     ((uint8_t )0x00)        /*!< Bit Value =(0):Normal of 8bit */
#define APX_STA_SDTF2_happened_w                    ((uint32_t)0x00000400)  /*!< Bit Value =(1):Happened of 32bit */
#define APX_STA_SDTF2_happened_h0                   ((uint16_t)0x0400)      /*!< Bit Value =(1):Happened of 16bit */
#define APX_STA_SDTF2_happened_b1                   ((uint8_t )0x04)        /*!< Bit Value =(1):Happened of 8bit */

#define APX_STA_SDTF1_mask_w                        ((uint32_t)0x00000200)  /*!< Bit Mask of 32bit */
#define APX_STA_SDTF1_mask_h0                       ((uint16_t)0x0200)      /*!< Bit Mask of 16bit */
#define APX_STA_SDTF1_mask_b1                       ((uint8_t )0x02)        /*!< Bit Mask of 8bit */
#define APX_STA_SDTF1_normal_w                      ((uint32_t)0x00000000)  /*!< Bit Value =(0):Normal of 32bit */
#define APX_STA_SDTF1_normal_h0                     ((uint16_t)0x0000)      /*!< Bit Value =(0):Normal of 16bit */
#define APX_STA_SDTF1_normal_b1                     ((uint8_t )0x00)        /*!< Bit Value =(0):Normal of 8bit */
#define APX_STA_SDTF1_happened_w                    ((uint32_t)0x00000200)  /*!< Bit Value =(1):Happened of 32bit */
#define APX_STA_SDTF1_happened_h0                   ((uint16_t)0x0200)      /*!< Bit Value =(1):Happened of 16bit */
#define APX_STA_SDTF1_happened_b1                   ((uint8_t )0x02)        /*!< Bit Value =(1):Happened of 8bit */

#define APX_STA_SDTF0_mask_w                        ((uint32_t)0x00000100)  /*!< Bit Mask of 32bit */
#define APX_STA_SDTF0_mask_h0                       ((uint16_t)0x0100)      /*!< Bit Mask of 16bit */
#define APX_STA_SDTF0_mask_b1                       ((uint8_t )0x01)        /*!< Bit Mask of 8bit */
#define APX_STA_SDTF0_normal_w                      ((uint32_t)0x00000000)  /*!< Bit Value =(0):Normal of 32bit */
#define APX_STA_SDTF0_normal_h0                     ((uint16_t)0x0000)      /*!< Bit Value =(0):Normal of 16bit */
#define APX_STA_SDTF0_normal_b1                     ((uint8_t )0x00)        /*!< Bit Value =(0):Normal of 8bit */
#define APX_STA_SDTF0_happened_w                    ((uint32_t)0x00000100)  /*!< Bit Value =(1):Happened of 32bit */
#define APX_STA_SDTF0_happened_h0                   ((uint16_t)0x0100)      /*!< Bit Value =(1):Happened of 16bit */
#define APX_STA_SDTF0_happened_b1                   ((uint8_t )0x01)        /*!< Bit Value =(1):Happened of 8bit */
...
#define APX_INT_SDT_IE3_mask_w                      ((uint32_t)0x00000800)  /*!< Bit Mask of 32bit */
#define APX_INT_SDT_IE3_mask_h0                     ((uint16_t)0x0800)      /*!< Bit Mask of 16bit */
#define APX_INT_SDT_IE3_mask_b1                     ((uint8_t )0x08)        /*!< Bit Mask of 8bit */
#define APX_INT_SDT_IE3_disable_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0):Disable of 32bit */
#define APX_INT_SDT_IE3_disable_h0                  ((uint16_t)0x0000)      /*!< Bit Value =(0):Disable of 16bit */
#define APX_INT_SDT_IE3_disable_b1                  ((uint8_t )0x00)        /*!< Bit Value =(0):Disable of 8bit */
#define APX_INT_SDT_IE3_enable_w                    ((uint32_t)0x00000800)  /*!< Bit Value =(1):Enable of 32bit */
#define APX_INT_SDT_IE3_enable_h0                   ((uint16_t)0x0800)      /*!< Bit Value =(1):Enable of 16bit */
#define APX_INT_SDT_IE3_enable_b1                   ((uint8_t )0x08)        /*!< Bit Value =(1):Enable of 8bit */

#define APX_INT_SDT_IE2_mask_w                      ((uint32_t)0x00000400)  /*!< Bit Mask of 32bit */
#define APX_INT_SDT_IE2_mask_h0                     ((uint16_t)0x0400)      /*!< Bit Mask of 16bit */
#define APX_INT_SDT_IE2_mask_b1                     ((uint8_t )0x04)        /*!< Bit Mask of 8bit */
#define APX_INT_SDT_IE2_disable_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0):Disable of 32bit */
#define APX_INT_SDT_IE2_disable_h0                  ((uint16_t)0x0000)      /*!< Bit Value =(0):Disable of 16bit */
#define APX_INT_SDT_IE2_disable_b1                  ((uint8_t )0x00)        /*!< Bit Value =(0):Disable of 8bit */
#define APX_INT_SDT_IE2_enable_w                    ((uint32_t)0x00000400)  /*!< Bit Value =(1):Enable of 32bit */
#define APX_INT_SDT_IE2_enable_h0                   ((uint16_t)0x0400)      /*!< Bit Value =(1):Enable of 16bit */
#define APX_INT_SDT_IE2_enable_b1                   ((uint8_t )0x04)        /*!< Bit Value =(1):Enable of 8bit */

#define APX_INT_SDT_IE1_mask_w                      ((uint32_t)0x00000200)  /*!< Bit Mask of 32bit */
#define APX_INT_SDT_IE1_mask_h0                     ((uint16_t)0x0200)      /*!< Bit Mask of 16bit */
#define APX_INT_SDT_IE1_mask_b1                     ((uint8_t )0x02)        /*!< Bit Mask of 8bit */
#define APX_INT_SDT_IE1_disable_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0):Disable of 32bit */
#define APX_INT_SDT_IE1_disable_h0                  ((uint16_t)0x0000)      /*!< Bit Value =(0):Disable of 16bit */
#define APX_INT_SDT_IE1_disable_b1                  ((uint8_t )0x00)        /*!< Bit Value =(0):Disable of 8bit */
#define APX_INT_SDT_IE1_enable_w                    ((uint32_t)0x00000200)  /*!< Bit Value =(1):Enable of 32bit */
#define APX_INT_SDT_IE1_enable_h0                   ((uint16_t)0x0200)      /*!< Bit Value =(1):Enable of 16bit */
#define APX_INT_SDT_IE1_enable_b1                   ((uint8_t )0x02)        /*!< Bit Value =(1):Enable of 8bit */

#define APX_INT_SDT_IE0_mask_w                      ((uint32_t)0x00000100)  /*!< Bit Mask of 32bit */
#define APX_INT_SDT_IE0_mask_h0                     ((uint16_t)0x0100)      /*!< Bit Mask of 16bit */
#define APX_INT_SDT_IE0_mask_b1                     ((uint8_t )0x01)        /*!< Bit Mask of 8bit */
#define APX_INT_SDT_IE0_disable_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0):Disable of 32bit */
#define APX_INT_SDT_IE0_disable_h0                  ((uint16_t)0x0000)      /*!< Bit Value =(0):Disable of 16bit */
#define APX_INT_SDT_IE0_disable_b1                  ((uint8_t )0x00)        /*!< Bit Value =(0):Disable of 8bit */
#define APX_INT_SDT_IE0_enable_w                    ((uint32_t)0x00000100)  /*!< Bit Value =(1):Enable of 32bit */
#define APX_INT_SDT_IE0_enable_h0                   ((uint16_t)0x0100)      /*!< Bit Value =(1):Enable of 16bit */
#define APX_INT_SDT_IE0_enable_b1                   ((uint8_t )0x01)        /*!< Bit Value =(1):Enable of 8bit */
...
#define APX_SDT0_SDT_E1SEL_mask_w                   ((uint32_t)0x01000000)  /*!< Bit Mask of 32bit */
#define APX_SDT0_SDT_E1SEL_mask_h1                  ((uint16_t)0x0100)      /*!< Bit Mask of 16bit */
#define APX_SDT0_SDT_E1SEL_mask_b3                  ((uint8_t )0x01)        /*!< Bit Mask of 8bit */
#define APX_SDT0_SDT_E1SEL_sdt_i0_w                 ((uint32_t)0x00000000)  /*!< Bit Value =(0):SDT_I0 of 32bit */
#define APX_SDT0_SDT_E1SEL_sdt_i0_h1                ((uint16_t)0x0000)      /*!< Bit Value =(0):SDT_I0 of 16bit */
#define APX_SDT0_SDT_E1SEL_sdt_i0_b3                ((uint8_t )0x00)        /*!< Bit Value =(0):SDT_I0 of 8bit */
#define APX_SDT0_SDT_E1SEL_sdt_i1_w                 ((uint32_t)0x01000000)  /*!< Bit Value =(1):SDT_I1 of 32bit */
#define APX_SDT0_SDT_E1SEL_sdt_i1_h1                ((uint16_t)0x0100)      /*!< Bit Value =(1):SDT_I1 of 16bit */
#define APX_SDT0_SDT_E1SEL_sdt_i1_b3                ((uint8_t )0x01)        /*!< Bit Value =(1):SDT_I1 of 8bit */

#define APX_SDT0_SDT_E0NS_mask_w                    ((uint32_t)0x00700000)  /*!< Bit Mask of 32bit */
#define APX_SDT0_SDT_E0NS_mask_h1                   ((uint16_t)0x0070)      /*!< Bit Mask of 16bit */
#define APX_SDT0_SDT_E0NS_mask_b2                   ((uint8_t )0x70)        /*!< Bit Mask of 8bit */
#define APX_SDT0_SDT_E0NS_proc0_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0x0):PROC0 of 32bit */
#define APX_SDT0_SDT_E0NS_proc0_h1                  ((uint16_t)0x0000)      /*!< Bit Value =(0x0):PROC0 of 16bit */
#define APX_SDT0_SDT_E0NS_proc0_b2                  ((uint8_t )0x00)        /*!< Bit Value =(0x0):PROC0 of 8bit */
#define APX_SDT0_SDT_E0NS_proc1_w                   ((uint32_t)0x00100000)  /*!< Bit Value =(0x1):PROC1 of 32bit */
#define APX_SDT0_SDT_E0NS_proc1_h1                  ((uint16_t)0x0010)      /*!< Bit Value =(0x1):PROC1 of 16bit */
#define APX_SDT0_SDT_E0NS_proc1_b2                  ((uint8_t )0x10)        /*!< Bit Value =(0x1):PROC1 of 8bit */
#define APX_SDT0_SDT_E0NS_proc2_w                   ((uint32_t)0x00200000)  /*!< Bit Value =(0x2):PROC2 of 32bit */
#define APX_SDT0_SDT_E0NS_proc2_h1                  ((uint16_t)0x0020)      /*!< Bit Value =(0x2):PROC2 of 16bit */
#define APX_SDT0_SDT_E0NS_proc2_b2                  ((uint8_t )0x20)        /*!< Bit Value =(0x2):PROC2 of 8bit */
#define APX_SDT0_SDT_E0NS_proc3_w                   ((uint32_t)0x00300000)  /*!< Bit Value =(0x3):PROC3 of 32bit */
#define APX_SDT0_SDT_E0NS_proc3_h1                  ((uint16_t)0x0030)      /*!< Bit Value =(0x3):PROC3 of 16bit */
#define APX_SDT0_SDT_E0NS_proc3_b2                  ((uint8_t )0x30)        /*!< Bit Value =(0x3):PROC3 of 8bit */
#define APX_SDT0_SDT_E0NS_proc4_w                   ((uint32_t)0x00400000)  /*!< Bit Value =(0x4):PROC4 of 32bit */
#define APX_SDT0_SDT_E0NS_proc4_h1                  ((uint16_t)0x0040)      /*!< Bit Value =(0x4):PROC4 of 16bit */
#define APX_SDT0_SDT_E0NS_proc4_b2                  ((uint8_t )0x40)        /*!< Bit Value =(0x4):PROC4 of 8bit */
#define APX_SDT0_SDT_E0NS_proc5_w                   ((uint32_t)0x00500000)  /*!< Bit Value =(0x5):PROC5 of 32bit */
#define APX_SDT0_SDT_E0NS_proc5_h1                  ((uint16_t)0x0050)      /*!< Bit Value =(0x5):PROC5 of 16bit */
#define APX_SDT0_SDT_E0NS_proc5_b2                  ((uint8_t )0x50)        /*!< Bit Value =(0x5):PROC5 of 8bit */

#define APX_SDT0_SDT_E0AS_mask_w                    ((uint32_t)0x00070000)  /*!< Bit Mask of 32bit */
#define APX_SDT0_SDT_E0AS_mask_h1                   ((uint16_t)0x0007)      /*!< Bit Mask of 16bit */
#define APX_SDT0_SDT_E0AS_mask_b2                   ((uint8_t )0x07)        /*!< Bit Mask of 8bit */
#define APX_SDT0_SDT_E0AS_disable_w                 ((uint32_t)0x00000000)  /*!< Bit Value =(0x0):DIsable of 32bit */
#define APX_SDT0_SDT_E0AS_disable_h1                ((uint16_t)0x0000)      /*!< Bit Value =(0x0):DIsable of 16bit */
#define APX_SDT0_SDT_E0AS_disable_b2                ((uint8_t )0x00)        /*!< Bit Value =(0x0):DIsable of 8bit */
#define APX_SDT0_SDT_E0AS_proc1_w                   ((uint32_t)0x00010000)  /*!< Bit Value =(0x1):PROC1 of 32bit */
#define APX_SDT0_SDT_E0AS_proc1_h1                  ((uint16_t)0x0001)      /*!< Bit Value =(0x1):PROC1 of 16bit */
#define APX_SDT0_SDT_E0AS_proc1_b2                  ((uint8_t )0x01)        /*!< Bit Value =(0x1):PROC1 of 8bit */
#define APX_SDT0_SDT_E0AS_proc2_w                   ((uint32_t)0x00020000)  /*!< Bit Value =(0x2):PROC2 of 32bit */
#define APX_SDT0_SDT_E0AS_proc2_h1                  ((uint16_t)0x0002)      /*!< Bit Value =(0x2):PROC2 of 16bit */
#define APX_SDT0_SDT_E0AS_proc2_b2                  ((uint8_t )0x02)        /*!< Bit Value =(0x2):PROC2 of 8bit */
#define APX_SDT0_SDT_E0AS_proc3_w                   ((uint32_t)0x00030000)  /*!< Bit Value =(0x3):PROC3 of 32bit */
#define APX_SDT0_SDT_E0AS_proc3_h1                  ((uint16_t)0x0003)      /*!< Bit Value =(0x3):PROC3 of 16bit */
#define APX_SDT0_SDT_E0AS_proc3_b2                  ((uint8_t )0x03)        /*!< Bit Value =(0x3):PROC3 of 8bit */
#define APX_SDT0_SDT_E0AS_proc4_w                   ((uint32_t)0x00040000)  /*!< Bit Value =(0x4):PROC4 of 32bit */
#define APX_SDT0_SDT_E0AS_proc4_h1                  ((uint16_t)0x0004)      /*!< Bit Value =(0x4):PROC4 of 16bit */
#define APX_SDT0_SDT_E0AS_proc4_b2                  ((uint8_t )0x04)        /*!< Bit Value =(0x4):PROC4 of 8bit */
#define APX_SDT0_SDT_E0AS_proc5_w                   ((uint32_t)0x00050000)  /*!< Bit Value =(0x5):PROC5 of 32bit */
#define APX_SDT0_SDT_E0AS_proc5_h1                  ((uint16_t)0x0005)      /*!< Bit Value =(0x5):PROC5 of 16bit */
#define APX_SDT0_SDT_E0AS_proc5_b2                  ((uint8_t )0x05)        /*!< Bit Value =(0x5):PROC5 of 8bit */
...
#define APX_SDT0_SDT_PSEL_proc0_w                   ((uint32_t)0x00000000)  /*!< Bit Value =(0x0):PROC0 of 32bit */
#define APX_SDT0_SDT_PSEL_proc0_h0                  ((uint16_t)0x0000)      /*!< Bit Value =(0x0):PROC0 of 16bit */
#define APX_SDT0_SDT_PSEL_proc0_b1                  ((uint8_t )0x00)        /*!< Bit Value =(0x0):PROC0 of 8bit */
#define APX_SDT0_SDT_PSEL_proc1_w                   ((uint32_t)0x00000100)  /*!< Bit Value =(0x1):PROC1 of 32bit */
#define APX_SDT0_SDT_PSEL_proc1_h0                  ((uint16_t)0x0100)      /*!< Bit Value =(0x1):PROC1 of 16bit */
#define APX_SDT0_SDT_PSEL_proc1_b1                  ((uint8_t )0x01)        /*!< Bit Value =(0x1):PROC1 of 8bit */
#define APX_SDT0_SDT_PSEL_proc2_w                   ((uint32_t)0x00000200)  /*!< Bit Value =(0x2):PROC2 of 32bit */
#define APX_SDT0_SDT_PSEL_proc2_h0                  ((uint16_t)0x0200)      /*!< Bit Value =(0x2):PROC2 of 16bit */
#define APX_SDT0_SDT_PSEL_proc2_b1                  ((uint8_t )0x02)        /*!< Bit Value =(0x2):PROC2 of 8bit */
#define APX_SDT0_SDT_PSEL_proc3_w                   ((uint32_t)0x00000300)  /*!< Bit Value =(0x3):PROC3 of 32bit */
#define APX_SDT0_SDT_PSEL_proc3_h0                  ((uint16_t)0x0300)      /*!< Bit Value =(0x3):PROC3 of 16bit */
#define APX_SDT0_SDT_PSEL_proc3_b1                  ((uint8_t )0x03)        /*!< Bit Value =(0x3):PROC3 of 8bit */
...
#define APX_SDT0_SDT_PSEL_e0_w                      ((uint32_t)0x00000800)  /*!< Bit Value =(0x8):E0 of 32bit */
#define APX_SDT0_SDT_PSEL_e0_h0                     ((uint16_t)0x0800)      /*!< Bit Value =(0x8):E0 of 16bit */
#define APX_SDT0_SDT_PSEL_e0_b1                     ((uint8_t )0x08)        /*!< Bit Value =(0x8):E0 of 8bit */
#define APX_SDT0_SDT_PSEL_e1_w                      ((uint32_t)0x00000900)  /*!< Bit Value =(0x9):E1 of 32bit */
#define APX_SDT0_SDT_PSEL_e1_h0                     ((uint16_t)0x0900)      /*!< Bit Value =(0x9):E1 of 16bit */
#define APX_SDT0_SDT_PSEL_e1_b1                     ((uint8_t )0x09)        /*!< Bit Value =(0x9):E1 of 8bit */
#define APX_SDT0_SDT_PSEL_e2_w                      ((uint32_t)0x00000A00)  /*!< Bit Value =(0xA):E2 of 32bit */
#define APX_SDT0_SDT_PSEL_e2_h0                     ((uint16_t)0x0A00)      /*!< Bit Value =(0xA):E2 of 16bit */
#define APX_SDT0_SDT_PSEL_e2_b1                     ((uint8_t )0x0A)        /*!< Bit Value =(0xA):E2 of 8bit */
