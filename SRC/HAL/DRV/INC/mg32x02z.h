...
#ifndef _MG32x02z_H
#define _MG32x02z_H
#define _MG32x02z_H_VER                             1.12    /*!< File Version */
...
typedef union
{								
	uint8_t    B[4];			/*!< Byte 8-bit 		*/
	uint16_t   H[2];			/*!< Half-Word 16-bit 	*/
	uint32_t   W;				/*!< Word 32-bit 		*/
} ctype;
...
// */
//#define HW_SetBit(_reg, _mask)		HW_WriteReg(_reg, (HW_ReadReg(_reg) | (_mask))) /*!< Hardware Set Register Bit */
...
// * @param  _mask : definitions of register mask value, like MODULE_REGNAME_mask
// */
//#define HW_ClrBit(_reg, _mask)		HW_WriteReg(_reg, (HW_ReadReg(_reg) & ~(_mask)))    /*!< Hardware Clear Register Bit */

/**
 * @brief  get register bit value
 ...
 * @param  REG : definitions of register name, like MODULE_REGNAME
 */
#define READ_REG(REG)         ((REG))                                               /*!< Hardware Write Register */
